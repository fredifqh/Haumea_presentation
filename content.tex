...
\begin{frame}[c]{}{}
	...
	\begin{figure}[tb]
		\centering
		\includegraphics[width = 5.5cm, height = 5.5cm]{dwarf_planets_kb.jpg}
	\end{figure}
...
\begin{frame}[c]{Haumea}{}
	...
	\begin{column}[T]{5cm}
		...
		\begin{figure}[tb]
		\centering
		\includegraphics[width = 5cm, height = 5cm]{haumea-ring.jpg}
	\end{figure}
...
Occultation of the star URAT1 533-182543 by the dwarf planet Haumea. Positive occultation detections were obtained on 21 January 2017, predicted time (around 3:09 ut).
	\begin{figure}[tb]
		\centering
		\includegraphics[scale = 0.23]{observatories_map}
	\end{figure}
\end{frame}

%-------------------------------------------------------------

\begin{frame}[c]{Light Curves}
\scriptsize
\justifying 
\vspace{-0.2 cm}
	\begin{figure}[tb]
		\centering
		\includegraphics[width = 8cm, height = 6cm]{light_curve_haumea_occultation}
	\end{figure}
\vspace{-0.2 cm}
\begin{block}{}
...
Square-well fits to the drops provide the times of star disappearance and reappearance at each site. Those times define an occultation chord for each site, and an elliptical fit to the extremities of the chord provides the instantaneous limb of Haumea.
	...
	\begin{column}[T]{5cm}
		\begin{figure}[tb]
			\centering
			\includegraphics[width=\textwidth]{ellipse_haumea_projection}
		\end{figure}
		\end{column}
	\begin{column}[T]{5cm}
	\vspace{2 cm}
...
In addition to the main occultation, there are brief dimmings before and after the main event.
	...
	\begin{column}[T]{5cm}
		\begin{figure}[tb]
			\centering
			\includegraphics[width = 4.5cm, height = 6cm]{ring_haumea}
		\end{figure}
	\end{column}
	\begin{column}[T]{5cm}
	\begin{itemize}
